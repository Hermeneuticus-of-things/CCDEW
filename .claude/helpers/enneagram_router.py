...
def cmd_wings(args):
    ...
    wing_data = [
        ('maha', 'zoom', 'Zoom-wing: Maha', 'System-level view'),
        ('macro', 'zoom', 'Zoom-wing: Macro', 'Component-level view'),
        ('mezzo', 'zoom', 'Zoom-wing: Mezzo', 'Process/flow view'),
        ('micro', 'zoom', 'Zoom-wing: Micro', 'Intra-component view'),
        ('nano', 'zoom', 'Zoom-wing: Nano', 'Atomic view'),
        ('stylistic', 'lens', 'Lens: stylistic', 'Aesthetic/literary filter'),
        ('doctrinal', 'lens', 'Lens: doctrinal', 'Source fidelity filter'),
        ('structural', 'lens', 'Lens: structural', 'Architectural filter'),
        ('regression', 'lens', 'Lens: regression', 'What doesn\'t work'),
        ('memory', 'lens', 'Lens: memory', 'Continuity with past'),
        ('agent', 'perspective', 'Perspective: agent', 'From actor view'),
        ('observer', 'perspective', 'Perspective: observer', 'External neutral'),
        ('cosmic', 'perspective', 'Perspective: cosmic', 'Systemic view'),
        ('sakshi', 'perspective', 'Perspective: Sakshi', 'Non-involved witness'),
        ('descriptive', 'modality', 'Modality: descriptive', 'As it is'),
        ('normative', 'modality', 'Modality: normative', 'As it should be'),
        ('generative', 'modality', 'Modality: generative', 'What if'),
        ('critical', 'modality', 'Modality: critical', 'What doesn\'t work'),
    ]
