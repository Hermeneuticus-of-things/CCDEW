...
|---|---|---|
| Inteleg structura cartii + protocoale | `BOOK_STRUCTURE.md` | Capitole, foldere, ierarhie surse, protocoale, stare |
| Export Scrivener / preview / tools | `EXPORT_TOOLS.md` | Scripts, teme, preview LIVE, integrari |
